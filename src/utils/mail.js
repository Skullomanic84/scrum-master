...
const sendEmail = async (options) => {
  ...
  try {
    ...
    console.error(
      'Email service failing silently. Make sure that you check you have provided the correct Mailtrap credentials ',
      error,
    );
  }
};
...
const forgotPasswordMailgenContent = (username, resetPasswordUrl) => {
  return {
    body: {
      ...
      action: {
        instructions:
          'To reset on your password please click on the button below.',
        button: {
          text: 'Reset Password',
      ...
      outro:
        "Need help, or have questions ? Jst reply  to this email, we'd love to help.",
    },
  };
};
